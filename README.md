...
3. Apa email yang digunakan untuk login? Filter htttp, cari yang di POST kemudian follow HTTP stream dan telusuri semua streamnya, disini kami menemukan email unik yaitu jarkomsupport@gmail.com
...
3. Di port berapa DBMS server tersebut berjalan? Disini awalnya kami mencoba menjawab 5432, namun karena salah, kami mencoba submit 6969 dan jawabannya benar

   <img width="602" alt="image" src="https://github.com/user-attachments/assets/d7478eeb-1143-4147-adc7-be559e7dc437">

4. OS apa yang digunakan untuk server tersebut? Saat kami telusuri TCP stream, pada stream 8 kami menemukan informasi tentang OS yang digunakan, yaitu Debian

   <img width="607" alt="image" src="https://github.com/user-attachments/assets/303db3be-cdc1-4097-8bf6-9cbaa8f8a82e">

5. Apa credentials username DBMS valid yang digunakan?
